...
namespace ApplicationCore.Logging
{
    public static class Logger
    {
        ...
        public static string LoggerPathRoot { get; set; }

        static Logger()
        {

            LoggerPathRoot = "D:\\Temp\\logging\\"; // todo configuration
            ...
            _perfLogger = new LoggerConfiguration()
                .WriteTo.File(path: LoggerPathRoot + "perffile.txt")
            ...
            _usageLogger = new LoggerConfiguration()
                .WriteTo.File(path: LoggerPathRoot + "usagefile.txt")
            ...
            _errorLogger = new LoggerConfiguration()
                .WriteTo.File(path: LoggerPathRoot + "errorfile.txt")
            ...
            _diagnosticLogger = new LoggerConfiguration()
                .WriteTo.File(path: LoggerPathRoot + "diagnosticfile.txt")
        ...
        public static void SetEnableDiagnostics(bool enable)
        {
        ...
        {
            //var writeDiagnostics = Convert.ToBoolean(System.Configuration.ConfigurationManager.AppSettings["EnableDiagnostics"]);
            //if (!writeDiagnostics)
            //    return;
